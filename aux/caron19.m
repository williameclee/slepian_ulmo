dataFolder = fullfile(getenv('IFILES'), 'GIA', 'Caron19');
inputFile = 'GIA_maps_Caron_Ivins_2019.txt';
...
save(fullfile(dataFolder, 'Caron19_SD.mat'), 'lmcosiM', 'lmcosiU', 'lmcosiL')
...
save(fullfile(dataFolder, 'Caron19_VLM.mat'), 'lmcosiM', 'lmcosiU', 'lmcosiL')
